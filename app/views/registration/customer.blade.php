    ...
    <div class="col-sm-3 col-md-10 col-lg-12">
        <div class="container">
                ...
                <div class="form-group" style="margin-top:10px;">
                    <label for="Name" class="col-sm-3 control-label" style="text-align: -webkit-auto;">I am looking for*</label>
                    <div class="col-sm-3">
                ...
                <div class="form-group">
                    <label for="Name" class="col-sm-3 control-label" style="text-align: -webkit-auto;">Age Range*</label>
