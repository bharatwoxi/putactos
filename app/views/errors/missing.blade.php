...
<div class="wrapper">
    ...
    <div class="mainWrapper">
        ...
        <div id="logo"><a href="http://mogoolab.com" title="Traffic 404 Custom Error Page">MogooLab</a></div>
        ...
        <footer>
            ...
            <menu>
                ...
                <li><a href="http://mogoolab.com/category/portfolio/" title="Portfolio">Portfolio</a></li>
                <li><a href="http://mogoolab.com/" title="Sitemap">Sitemap</a></li>
                <li><a href="http://mogoolab.com/contact" title="Contact">Contact</a></li>
            </menu>
        </footer>
        <!-- end footer -->
    </div>
