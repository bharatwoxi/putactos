...
<!--                                    <input class="slider" name="cup" id="cup" data-slider-max="80" data-slider-min="20" data-slider-orientation="horizontal" data-slider-value="20" type="text">-->
                                    ...
                                    <div class="slider-example">
                                        <div class="well" style="padding: 5px 0px 5px 0px;">
                                            ...
                                            <div class="slider1 slider-horizontal1" id="">
                                                <!--                                                    <div class="slider-track" style="display:none">-->
                                                <!--                                                        <div class="slider-selection" style="left: 30%; width: 20%;"></div>-->
                                                <!--                                                        <div class="slider-handle min-slider-handle round" tabindex="0" style="left: 30%;"></div>-->
                                                <!--                                                        <div class="slider-handle max-slider-handle round" tabindex="0" style="left: 50%;"></div>-->
                                                <!--                                                    </div>-->
                                            ...
                                            <input id="ex2" type="text" class="span2" value="25,35" data-slider-min="10" data-slider-max="60" data-slider-step="5" data-slider-value="[16,60]" data="value: '25,35'" style="display: none;"> <b style="color:#FFF">&nbsp;&nbsp;&nbsp;60</b>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slider-example">
                                        <div class="well" style="padding: 5px 0px 5px 0px;">
                                            ...
                                            <input id="ex3" type="text" class="span2" value="25,35" data-slider-min="10" data-slider-max="60" data-slider-step="5" data-slider-value="[16,60]" data="value: '25,35'" style="display: none;"> <b style="color:#FFF">&nbsp;&nbsp;&nbsp;60</b>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slider-example">
                                        <div class="well" style="padding: 5px 0px 5px 0px;">
                                            ...
                                            <input id="ex4" type="text" class="span2" value="25,35" data-slider-min="10" data-slider-max="60" data-slider-step="5" data-slider-value="[16,60]" data="value: '25,35'" style="display: none;"> <b style="color:#FFF">&nbsp;&nbsp;&nbsp;60</b>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slider-example">
                                        <div class="well" style="padding: 5px 0px 5px 0px;">
                                            ...
                                            <input id="ex5" type="text" class="span2" value="25,35" data-slider-min="10" data-slider-max="60" data-slider-step="5" data-slider-value="[16,60]" data="value: '25,35'" style="display: none;"> <b style="color:#FFF">&nbsp;&nbsp;&nbsp;60</b>
                                        </div>
                                    </div>
