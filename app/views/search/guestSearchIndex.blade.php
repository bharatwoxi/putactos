            ...
            <div>
                ...
                <div class="pull-right">
                    <p  style="padding-top: 15px;">{{ trans('peopleNearBy.NotaMember?') }}
                        <a href="{{ URL::to('/signup/customer') }}" style="text-decoration: none;color:#FFF"><button type="button" class="btn btn-default" style="background-color:#a92124; color:#ffffff">{{ trans('peopleNearBy.JoinPutactos') }}</button></a>
                    </p>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-xs-12 col-md-3 center-block" style="background-color:#f74d4d">
                                <h4 style="color:#FFF; font-family:Calibri"><!--{{ trans('peopleNearBy.PUBICHAIR') }}-->P H</h4>
...
<!--                                </div>-->
                                <div class=" col-xs-offset-1" id="women_only">
                                    <h6 style="color:#FFF"><!--{{ trans('peopleNearBy.HIPS') }}-->H</h6>
                                    ...
                                    <h6 style="color:#FFF"><!--{{ trans('peopleNearBy.BUST') }}-->B</h6>
                                    <div class="slider-example">
                                        <div class="well" style="padding: 5px 0px 5px 0px;">
                                            <b style="color:#FFF">40&nbsp;&nbsp;</b>
                                            <div class="slider1 slider-horizontal1" id="">
                                    ...
                                    <h6 style="color:#FFF"><!--{{ trans('peopleNearBy.WAIST') }}-->W</h6>
                                    <div class="slider-example">
                                        <div class="well" style="padding: 5px 0px 5px 0px;">
                                            <b style="color:#FFF">40&nbsp;&nbsp;</b>
                                            <div class="slider1 slider-horizontal1" id="">
...
<!--                                    </div>-->
                                ...
                                <div class=" col-xs-offset-1" id="men_only" style="display:none;">
                                    <h6 style="color:#FFF"><!--Penis Size-->P S</h6>
                                    <div class="slider-example">
                                        <div class="well" style="padding: 5px 0px 5px 0px;">
                                            <b style="color:#FFF">40&nbsp;&nbsp;</b>
                                            <div class="slider1 slider-horizontal1" id="">
