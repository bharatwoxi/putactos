...
?>
                    ...
                    <div class="col-md-3">
                        <p class="pull-left text-justify" style="padding:10px; font-family:Calibri Light">
                            <a href="{{ URL::to($serviceProviderData[$i]['system_user']['username']) }}"><img src="{{$profileImage}}" class="img-responsive" width="250px" style="display: block;max-width: 204px;height:180px;"></a>
