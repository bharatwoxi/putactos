...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/registration/slider/css/demo.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/registration/slider/css/style2.css')}}" />
    <script type="text/javascript" src="{{URL::asset('public/assets/registration/slider/js/modernizr.custom.28468.js')}}"></script>
    <noscript>
        <link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/registration/slider/css/nojs.css')}}" />
    </noscript>

    <script src="{{URL::asset('public/assets/registration/src/jquery.min.js')}}"></script>
...
<body>
    ...
    <script type="text/javascript" src="{{URL::asset('public/assets/registration/slider/js/jquery.cslider.js')}}"></script>
