...
<head>
    ...
    <link href="{{URL::asset('assets/registration/dropzone/css/dropzone.css')}}" type="text/css" rel="stylesheet" />
    <style>
...
<script type='text/javascript' src="{{URL::asset('assets/registration/dropzone/dropzone.js')}}"></script>
