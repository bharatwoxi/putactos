...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="{{URL::asset('public/assets/admin/admin/layout/img/logo.png')}}" alt="logo" class="logo-default"/>
			</a>
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject font-blue-madison bold uppercase">Last 10 Registered Users</span>
                                <span class="caption-helper hide">weekly stats...</span>
                            </div>
                            <!--<div class="actions">
                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                    <label class="btn btn-transparent grey-salsa btn-circle btn-sm active">
                                        <input type="radio" value="today" name="customer_stats" class="toggle">Today</label>
                                    <label class="btn btn-transparent grey-salsa btn-circle btn-sm">
                                        <input type="radio" value="week" name="customer_stats" class="toggle">Week</label>
                                    <label class="btn btn-transparent grey-salsa btn-circle btn-sm">
                                        <input type="radio" value="month" name="customer_stats" class="toggle">Month</label>
                                </div>
                            </div>-->
                        </div>
                        <div class="portlet-body">
