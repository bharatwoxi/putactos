...
<link href="{{URL::asset('public/assets/admin/global/plugins/select2/select2.css')}}" rel="stylesheet" type="text/css"/>
<link href="{{URL::asset('public/assets/admin/admin/pages/css/login-soft.css')}}" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="{{URL::asset('public/assets/admin/admin/layout/css/themes/darkblue.css')}}" rel="stylesheet" type="text/css"/>
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
        {{ Form::open(array('url' => 'admin/check-login','class'=>'login-form','role'=>'form','files'=>true,'id'=>'saveSpData')) }}
...
<script src="{{URL::asset('public/assets/admin/global/plugins/jquery-validation/js/jquery.validate.min.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('public/assets/admin/global/plugins/backstretch/jquery.backstretch.min.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{URL::asset('public/assets/admin/global/plugins/select2/select2.min.js')}}"></script>
...
<script src="{{URL::asset('public/assets/admin/admin/pages/scripts/login-soft.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
jQuery(document).ready(function() {     
  ...
  Demo.init();
       ...
       $.backstretch([
        "{{URL::asset('public/assets/admin/admin/pages/media/bg/1.jpg')}}",
        "{{URL::asset('public/assets/admin/admin/pages/media/bg/2.jpg')}}",
        "{{URL::asset('public/assets/admin/admin/pages/media/bg/3.jpg')}}",
        "{{URL::asset('public/assets/admin/admin/pages/media/bg/4.jpg')}}"
        ], {
          fade: 1000,
          duration: 8000
    }
